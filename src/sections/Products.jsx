...
export default function Products() {
  ...
  return (
    <section id="products" className="relative py-24 bg-white/40">
      <div className="max-w-7xl mx-auto px-6">
        <SectionReveal className="text-center max-w-2xl mx-auto mb-14">
          <span className="eyebrow">{t('products.eyebrow')}</span>
          <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-800 mt-4">{t('products.title')}</h2>
          <p className="text-slate-600 mt-4">{t('products.subtitle')}</p>
        </SectionReveal>
