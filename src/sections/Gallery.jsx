    ...
    <section id="gallery" className="relative py-24">
      <div className="max-w-7xl mx-auto px-6">
        <SectionReveal className="text-center max-w-2xl mx-auto mb-10">
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-800 mt-4">{t('gallery.title')}</h2>
          <p className="text-slate-600 mt-4">{t('gallery.subtitle')}</p>
        </SectionReveal>
            ...
            <button
              ...
              className={`px-5 py-2 rounded-full text-sm font-semibold transition-all ${
                activeCategory === cat
                  ...
                  : 'bg-white text-slate-600 shadow-clay-inset hover:shadow-clay'
              }`}
            >
